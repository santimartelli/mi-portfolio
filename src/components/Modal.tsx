    ...
    <motion.div
      ...
      <motion.div
        ...
        <div className="h-full flex flex-col rounded-sm relative">
          <button className="absolute top-2 right-2 bg-white/50 rounded-full transition-all duration-150 ease-in-out text-black hover:bg-white" onClick={onClose}>
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <div className="h-full flex flex-col rounded-b-sm">
            <div className="flex flex-grow flex-col justify-between gap-y-4">
              ...
              <div className="flex items-center justify-center px-10 text-sm rounded-b-sm py-1 bg-orange-700">
                <div className="flex gap-x-8">
                  <a
                    href={href}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-transparent rounded hover:bg-orange group py-1 px-2.5">
                    <span className="w-56 h-48 rounded bg-orange-600 absolute bottom-0 left-0 translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
                    <span className="flex gap-x-2 items-center relative w-full text-left text-white transition-colors duration-300 ease-in-out group-hover:text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href={github} target="_blank" rel="noopener noreferrer">
                    <button className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-transparent rounded hover:bg-orange group py-1 px-2.5">
                      <span className="w-56 h-48 rounded bg-orange-600 absolute bottom-0 left-0 translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
                      <span className="flex gap-x-2 items-center relative w-full text-left text-white transition-colors duration-300 ease-in-out group-hover:text-white">
                        <svg
                          viewBox="0 0 256 250"
