 ...
 * Muestra la trayectoria profesional, filosofía de desarrollo, habilidades técnicas
 * y lo que aporta a los proyectos, con animaciones al hacer scroll
 */
const AboutMeSection = () => {
  // Obtiene las traducciones de la sección "aboutme" (renombradas como 't' para brevedad)
  ...
  // Almacena el idioma actual para usar en las traducciones hardcodeadas
